...
decode_root=/mnt/nvme0n1/guoyujie_space/work/espnet/egs2/librispeech/asr1/exp/asr_train_asr_glad/decode_asr_aed_asr_model_avg_31-35
...
python ./get_res.py --path ${decode_root}
