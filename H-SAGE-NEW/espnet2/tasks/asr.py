...
encoder_choices = ClassChoices(
    "encoder",
    classes=dict(
        moe_conformer=MOE_ConformerEncoder,
...
class ASRTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            type=str_or_none,
            default=None,
            help="load model from pretrained model",
        )
    ...
    def build_model(cls, args: argparse.Namespace) -> ESPnetASRModel:
        ...
        if args.load_from_pretrained is not None:
            logging.info("Loading pretrained model from " + args.load_from_pretrained)
            model_dict = torch.load(args.load_from_pretrained)
